...
function diff(){
    ...
    $("#pageMyform tr").each(function(ind){
        if(ind!=0){
            ...
            cont += '<div width=\"100\" height=\"23\" role=\"gridcell\" style=\"color:'+color+';text-align:left;font-weight:bold;height:20px;margin-top:3px\" title=\"\" aria-describedby=\"added\">'+result+'&nbsp;'+msg+'</div>';
        }    
    });
    $div.append(cont);
    $div.click(function(){
